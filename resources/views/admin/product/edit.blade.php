                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <input required name="description" id="description"
                                               placeholder="Description" type="text" class="form-control" value="{{ $product->description }}">
                                    </div>
                                </div>
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <input required name="material" id="material"
                                               placeholder="Material" type="text" class="form-control" value="{{ $product->material }}">
                                    </div>
                                </div>
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <input required name="specification" id="specification"
                                               placeholder="Specification" type="text" class="form-control" value="{{ $product->specification }}">
                                    </div>
                                </div>
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <input required name="clothing_care" id="clothing_care"
                                               placeholder="Clothing care" type="text" class="form-control" value="{{ $product->clothing_care }}">
                                    </div>
                                </div>
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <div class="position-relative form-check pt-sm-2">
                                            <input name="featured" id="featured-yes" type="radio" value="1" {{$product->featured == 1 ? 'checked' : ''}} class="form-check-input">
                                            <label for="featured-yes" class="form-check-label">Yes</label>
                                            <div></div>
                                            <input name="featured" id="featured-no" type="radio" value="0" {{$product->featured == 0 ? 'checked' : ''}} class="form-check-input">
